#
#  Be sure to run `pod spec lint OfflineSync.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  OfflineSync is a component designed to manage the synchronization of data between a local storage system and a remote database.
  ...
  spec.homepage     = "https://github.com/koejdga/OfflineSync"
  ...
  spec.author             = { "Sofiia Budilova" => "avolidub@gmail.com" }
  # Or just: spec.author    = "Sofiia Budilova"
  # spec.authors            = { "Sofiia Budilova" => "avolidub@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Sofiia Budilova"
  ...
  spec.source       = { :git => "https://github.com/koejdga/OfflineSync.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Sources/OfflineSync/*", "Sources/OfflineSync/**/*", "Sources/OfflineSync/**/**/*"
